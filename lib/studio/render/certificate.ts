...
export function buildCertificateHtml(input: CertificateInput): string {
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .cert{width:1123px;height:794px;margin:0 auto;padding:64px 80px;position:relative;background:radial-gradient(1200px 500px at 80% -10%, rgba(139,92,255,.16), transparent),#0B0B16;display:flex;flex-direction:column}
  ...
  .to{font-size:15px;color:#AFAFC6;margin-top:44px}
  ...
  .body{font-size:17px;color:#AFAFC6;margin-top:26px;max-width:80%;line-height:1.6}
  .body b{color:#F4F4FA}
  ...
  .sign .n{font-family:'JetBrains Mono',monospace;font-size:13px;color:#F4F4FA}
  .sign .r{font-size:11px;color:#7A7A95;letter-spacing:.1em;text-transform:uppercase;margin-top:2px}
  .seal{width:96px;height:96px;border-radius:50%;border:2px solid ${accent};display:flex;align-items:center;justify-content:center;color:#EBF212;font-size:34px}
  .meta{font-family:'JetBrains Mono',monospace;font-size:12px;color:#7A7A95;margin-top:6px}
