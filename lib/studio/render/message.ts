...
export function buildMessageHtml(input: MessageInput): string {
  const accent = isV2Accent(input.accent) ? input.accent! : "#8B5CFF";
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .bubble{background:#14141F;border:1px solid rgba(255,255,255,.08);border-radius:16px;padding:22px 24px;font-size:16px;line-height:1.6;white-space:pre-wrap}
  ...
  .meta{margin-top:20px;padding-top:16px;border-top:1px solid rgba(255,255,255,.08);font-size:13px;color:#AFAFC6}
  .meta b{color:#F4F4FA}
  .var{font-family:'JetBrains Mono',monospace;color:${accent}}
  .visual{margin-top:14px;padding:14px 16px;border:1px dashed rgba(255,255,255,.14);border-radius:12px;color:#AFAFC6;font-size:14px}
  .variant{margin-top:12px;background:#14141F;border:1px solid rgba(255,255,255,.06);border-radius:12px;padding:14px 16px;font-size:14px;color:#AFAFC6}
  .foot{margin-top:22px;font-size:11px;letter-spacing:.2em;text-transform:uppercase;color:#7A7A95;font-family:'JetBrains Mono',monospace}`;
