...
export default async function AdminRoiPage({ searchParams }: { searchParams: Promise<{ periodo?: string }> }) {
  ...
  return (
    <div>
      ...
      {!anthropicConfigured() && <div className="card p-3 mb-4 border-goldline bg-[rgba(79, 31, 255,.06)]"><p className="text-sm text-gold">Sem ANTHROPIC_API_KEY: as métricas são calculadas, mas a narrativa fica vazia (você pode escrevê-la manualmente).</p></div>}
