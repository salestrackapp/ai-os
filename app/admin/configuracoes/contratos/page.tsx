...
export default async function ContratosConfigPage() {
  ...
  return (
    <div className="max-w-3xl">
      <p className="text-[11px] uppercase tracking-[.24em] text-muted2 mb-1">A Fortaleza · Jurídico</p>
      ...
      <form action={saveContractSettings} className="space-y-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <p className="text-[11px] text-muted2">Template base — validar com assessoria jurídica antes do primeiro envio real.</p>
        </div>
      </form>
    </div>
  );
