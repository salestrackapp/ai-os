...
export default async function EstudioPage() {
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="card p-6 border-goldline bg-[rgba(79, 31, 255,.04)]">
        ...
        <p className="text-[11px] text-muted2 mt-2">A IA gera título, passos e prompt pronto; salva como rascunho (não publicado) e abre para você revisar.</p>
      </div>
