...
import { ContentArea, PageHeader, botaoClasses } from "@/components/ds";
      ...
      <div className="mx-auto mt-2 max-w-xl rounded-ds-card border border-hairline bg-[var(--bg-1)] p-6 shadow-ds-card sm:p-8">
        <form action={criarEntregavelCatalogoAction} className="space-y-5">
          ...
          <div>
            ...
            <p className="mt-1 font-montserrat text-[13px] text-[color:var(--fg-4)]">Passo a passo (curso, treinamento, trilha, workshop, playbook) já cria os módulos.</p>
          </div>
          ...
          <label className="flex items-center gap-2 font-montserrat text-[14px] text-[color:var(--fg-2)]">
          ...
          <div className="flex items-center gap-3 pt-1">
            <button className={botaoClasses({ size: "lg" })}>Criar entregável</button>
            <span className="font-montserrat text-[13px] text-[color:var(--fg-4)]">Fica em rascunho até você aprovar. Aprovado → compartilhável por link.</span>
          </div>
        </form>
      </div>
    </ContentArea>
