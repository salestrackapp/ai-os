  ...
  return (
    <ContentArea>
      <div>
        ...
        {!(await googleConfigured()) && <div className="card p-3 mb-4 border-goldline bg-[rgba(0, 122, 148,.06)]"><p className="text-sm text-gold">Sem GOOGLE_OAUTH: aprovar e-mail marca como <b>aprovada</b> para envio manual (o Gmail não dispara automaticamente).</p></div>}
            ...
            return (
              <div key={m.id} className="card p-5">
                <div className="flex items-center justify-between gap-3 mb-3 flex-wrap">
                  ...
                  <span className="text-[13px] text-muted2">{p?.email ?? ""}</span>
                </div>
