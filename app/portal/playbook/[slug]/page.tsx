      ...
      <div className="max-w-3xl space-y-6">
        ...
        <div className="card p-8">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-[11px] uppercase tracking-[.14em] text-muted2">{r.frente}</span>
            ...
            <ol className="space-y-3">
              {passos.map((p, i) => (
                <li key={i} className="flex gap-3">
                  <span className="w-6 h-6 shrink-0 rounded-full bg-[rgba(0, 122, 148,.14)] border border-goldline text-gold flex items-center justify-center font-mono text-xs">{i + 1}</span>
