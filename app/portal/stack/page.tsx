...
const CLASS_BADGE: Record<string, string> = { publico: "badge-muted", interno: "badge-muted", confidencial: "badge-gold", restrito: "badge inline-flex text-[10px] uppercase tracking-[.14em] px-2.5 py-1 rounded-full border text-red-400 border-red-500/40 bg-red-500/10" };
