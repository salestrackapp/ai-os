          ...
          <div className="space-y-5">
            ...
            <div className="card p-6 space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <label className="flex items-center gap-2 text-muted"><input type="radio" name="plat" className="accent-[#007A94]" checked={platChoice === "claude"} onChange={() => setPlatChoice("claude")} /> Claude Team/Enterprise (recomendação primária)</label>
                <label className="flex items-center gap-2 text-muted"><input type="radio" name="plat" className="accent-[#007A94]" checked={platChoice === "stack"} onChange={() => setPlatChoice("stack")} /> Stack existente do cliente + trilha de migração</label>
              </div>
