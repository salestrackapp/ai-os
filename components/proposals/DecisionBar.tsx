            ...
            {modal === "approve" && (
              <>
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-center gap-2 text-sm text-muted"><input type="checkbox" className="accent-[#007A94]" checked={agree} onChange={(e) => setAgree(e.target.checked)} /> Li e aprovo esta proposta</label>
                </div>
